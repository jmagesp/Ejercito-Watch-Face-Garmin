...
function datos390_390(dc) {
    ...
    function empleo390_390(dc) {        
        ...
        if (SetEmpleo == 13) {
            ...
            dc.drawBitmap(80, 275, DibujoEmpleo);
        }
        if (SetEmpleo == 14) { 
    ...
    function dibujoCorazon390_390(dc)
    {
        ...
        if (SensorLatidos == true) {        
            ...
            dc.drawText(210, 25, corazonFont, "y", Graphics.TEXT_JUSTIFY_LEFT); //la y - codigo ascii de fnt
        } 
