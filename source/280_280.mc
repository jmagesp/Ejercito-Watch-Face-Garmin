...
using Toybox.Application;
    ...
    function empleo280_280(dc) {        
        ...
        if (SetEmpleo == 1) {
            ...
            dc.drawBitmap(45, 200, DibujoEmpleo);
        }
        if (SetEmpleo == 2) { 
        ...
        if (SetEmpleo == 3) {
            ...
            dc.drawBitmap(70, 200, DibujoEmpleo);
        }
        if (SetEmpleo == 4) { 
            DibujoEmpleo = Ui.loadResource(Rez.Drawables.Cap); //capitan +
            dc.drawBitmap(50, 200, DibujoEmpleo);
        } 
        if (SetEmpleo == 5) {
        ...
        if (SetEmpleo == 16) {
            ...
            dc.drawBitmap(55, 210, DibujoEmpleo);
        }
    }
