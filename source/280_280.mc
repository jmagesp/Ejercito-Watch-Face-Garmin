...
function datos280_280(dc) {
    ...
    function Reloj280_280(dc)
    {
        var ancho1  = (dc.getWidth()/2);
        var alto1  = (dc.getHeight()/2)-65;
    ...
    function dibujoCorazon280_280(dc)
    {
        ...
        if (SensorLatidos == true) {        
            ...
            dc.drawText(153, 14, corazonFont, "y", Graphics.TEXT_JUSTIFY_LEFT); //la y - codigo ascii de fnt
        } 
